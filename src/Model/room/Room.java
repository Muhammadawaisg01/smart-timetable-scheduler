...
//        {
        for (int i = 0; i < this.days.size(); i++) {
//            System.out.println(this.days.get(i).getNo() + "\t\t");
            for (int j = 0; j < this.days.get(i).getTimeslots().size(); j++) {
                System.out.println(this.days.get(i).getTimeslots().get(j).no + "   " + this.days.get(i).getTimeslots().get(j).check);
            }
            System.out.println("");
        }
    }
