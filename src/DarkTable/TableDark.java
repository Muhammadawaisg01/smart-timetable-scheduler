...
public class TableDark extends JTable{
    ...
    private class TableDarkHeader extends DefaultTableCellRenderer{
        ...
        public Component getTableCellRendererComponent(JTable jtable,  Object o , boolean bin, boolean bin1,  int i , int i1 ) { 
            Component com = super.getTableCellRendererComponent(jtable, o, bin1, bin1, i, i1) ; 
    ...
    private class TableDarkCell extends DefaultTableCellRenderer{
        ...
        @Override
        public Component getTableCellRendererComponent(JTable table, Object value, boolean bin, boolean bin1, int i, int i1) {
            Component com = super.getTableCellRendererComponent(table, value, bin, bin1, i, i1); 
