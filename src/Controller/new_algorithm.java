            ...
            for( int k = 0 ; k < req_section_array_1.size() ; k++ ) {   
                ...
                if( available_slots_in_room  >= num_of_total_slots_required ) {             // leave this if condition for a while
                    ...
                    for(int slot = 0 ; slot < all_available_slots.size() ; slot++ ){
                        ...
                        ArrayList<Section> high_priority_sections = get_all_sections_having_high_priority_on_consecutive_timeslots
                        (req_section_array_1, day, timeslot, no_of_consecutive_slots ) ;  
                        ...
                        if(high_priority_sections.size() == req_section_array_1.size() ) { 
                            ...
                            ArrayList<Section> medium_priority_sections = get_all_sections_having_medium_priority_on_consecutive_timeslots
                        (req_section_array_1, day, timeslot, no_of_consecutive_slots) ;
...
>>>>>>> d44d3c1510cedc48d8357b8376ad2588ed36df32
...
//    }
    ...
    private ArrayList<Section> get_all_sections_having_high_priority_on_consecutive_timeslots
        (ArrayList<Section> sections_array, int day, int timeslot, int num_of_consecutive_slots)  {   
        ArrayList<Section> new_sections_array = new ArrayList<>();
    ...
    private ArrayList<Section> get_all_sections_having_medium_priority_on_consecutive_timeslots
        (ArrayList<Section> sections_array, int day, int timeslot, int num_of_consecutive_slots){
        ArrayList<Section> new_sections_array = new ArrayList<>();
    ...
    private ArrayList<Section> get_all_sections_having_low_priority_on_consecutive_timeslots
        (ArrayList<Section> sections_array, int day, int timeslot, int num_of_consecutive_slots){
        ArrayList<Section> new_sections_array = new ArrayList<>();
